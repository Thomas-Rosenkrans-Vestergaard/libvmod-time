...
Time Varnish vmod demonstrating how to write an out-of-tree Varnish vmod.
...
The basic steps to start a new vmod from this time are::

  name=myvmod
  git clone libvmod-time libvmod-$name
  cd libvmod-$name
